...
- [`~/.claude/agent-docs/v1/rules/authoring-rules.md`](~/.claude/agent-docs/v1/rules/authoring-rules.md) — the generic rules (authoritative).
- [`~/.claude/agent-docs/v1/agent-docs-guide.md`](~/.claude/agent-docs/v1/agent-docs-guide.md) — why the system is shaped this way.
