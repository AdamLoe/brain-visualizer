...
export const MORPH_DESCRIPTORS: readonly MorphDescriptor[] = [
  ...
  { jsonPath: "generator.maxSegmentLength",           group: "generator", label: "Local segment length",    type: "number", min: 0.018, max: 0.12,  step: 0.002,  default: 0.05,  impact: "renderer-rebuild", applyKind: "regenerate", tooltip: "Target maximum straight subsegment length on local branches. Lower values add more straight polyline segments." },
  { jsonPath: "generator.longRangeMaxSegmentLength",  group: "generator", label: "Long segment length",     type: "number", min: 0.012, max: 0.08,  step: 0.001,  default: 0.025, impact: "renderer-rebuild", applyKind: "regenerate", tooltip: "Target maximum straight subsegment length on long-range axons. Lower values make long packets turn more gradually." },
  { jsonPath: "generator.curvatureSubsegmentBoost",   group: "generator", label: "Turn smoothing",          type: "number", min: 0.0,   max: 4.0,   step: 0.1,    default: 2.0,   impact: "renderer-rebuild", applyKind: "regenerate", tooltip: "Extra straight subsegments added to sharper branch turns." },
  { jsonPath: "generator.edgeSubsegmentsMax",         group: "generator", label: "Subsegment cap",          type: "int",    min: 1,     max: 4,     step: 1,      default: 4,     impact: "renderer-rebuild", applyKind: "regenerate", tooltip: "Hard cap for straight subsegments emitted per branch hop." },
  { jsonPath: "generator.minSubsegments",             group: "generator", label: "Subsegment floor",        type: "int",    min: 1,     max: 4,     step: 1,      default: 1,     impact: "renderer-rebuild", applyKind: "regenerate", tooltip: "Minimum straight subsegments emitted per branch hop." },
